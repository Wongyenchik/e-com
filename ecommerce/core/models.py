...
class Vendor(models.Model):
    ...
    contact=models.CharField(max_length=100, default="123 345 5353")
...
class Product(models.Model):
    pid = ShortUUIDField(unique=True, length=10, max_length=30, prefix="pid", alphabet="abcdefgh12345")
...
#This product images is for product more than one images
